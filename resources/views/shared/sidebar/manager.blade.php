...
<nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
    ...
    <!-- Laundry Section -->
    <div class="pt-4">
        <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Laundry</p>
    ...
    <!-- Conference Section -->
    <div class="pt-4">
        <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Conference</p>
        ...
        <a href="{{ route('conference-halls.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl {{ request()->routeIs('conference-halls.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50' }} transition-colors font-medium">
            ...
            <span class="ml-auto text-xs text-gray-400">(View)</span>
        </a>
    </div>
