{{-- resources/views/procurement/suppliers/create.blade.php --}}
@extends('layouts.app')
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-xl font-bold text-secondary">Create New Supplier</h2>
            <p class="text-sm text-gray-500 mt-1">Add a new supplier to your procurement system</p>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('procurement.suppliers.store') }}" class="p-6">
            @csrf
