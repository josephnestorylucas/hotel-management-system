...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex gap-2">
        ...
        <a href="{{ route('store.reports.movements.print', request()->query()) }}"
           target="_blank"
           class="bg-primary text-white px-4 py-2 rounded-xl text-sm hover:bg-blue-700 flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
            Print
        </a>
        <a href="{{ route('store.reports.movements.export.excel', request()->query()) }}"
           class="bg-green-600 text-white px-4 py-2 rounded-xl text-sm hover:bg-green-700 flex items-center gap-2">
