...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-white rounded-t-2xl">
            ...
            <p class="text-sm text-gray-500 mt-1">Register a new guest in the system</p>
        </div>
        ...
        <form method="POST" action="{{ route('guests.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            @if(request('return_to_reservation'))
            <input type="hidden" name="return_to_reservation" value="1">
            @endif
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="id_document" class="block text-sm font-semibold text-secondary mb-2">
                                ID Document <span class="text-gray-400 text-xs font-normal">(Optional, max 5MB)</span>
                            </label>
                            <input 
                                type="file" 
                                name="id_document" 
                    ...
                    <div class="mt-6">
                        <label for="photo" class="block text-sm font-semibold text-secondary mb-2">
                            Guest Photo <span class="text-gray-400 text-xs font-normal">(Optional, max 2MB)</span>
                        </label>
                        <input 
                            type="file" 
                            name="photo" 
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm">
                            ...
                            <ul class="list-disc list-inside space-y-1 text-gray-600">
                                ...
                                <li>Supported file formats: JPG, PNG, PDF (for documents)</li>
                            </ul>
                        </div>
                    </div>
                </div>
